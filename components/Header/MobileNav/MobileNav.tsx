    ...
    <Popover>
      ...
      <Transition.Root>
        ...
        >
          ...
          >
            <MobileNavLink href="#about"><a onClick={() => close()}>About</a></MobileNavLink>
            <MobileNavLink href="#experience"><a onClick={() => close()}>Experience</a></MobileNavLink>
            <MobileNavLink href="#projects"><a onClick={() => close()}>Projects</a></MobileNavLink>
            <MobileNavLink href="#contact"><a onClick={() => close()}>Contact</a></MobileNavLink>
